...
// Input 0 ('input') size: 256
// Output 0 ('output') size: 40
void mfcc_Predict(void* context, float* input, float* output);
...
public:
    MfccWrapper()
    {
        _output.resize(GetOutputSize(0));
    ...
    {
        mfcc_Predict(this, input.data(), _output.data());
        return _output;
    }
