...
def mfcc_Predict(context: 'void *', input: 'float *', output: 'float *') -> "void":
    """
...
def mfcc_Reset() -> "void":
    """mfcc_Reset()"""
    return _mfcc.mfcc_Reset()

def mfcc_GetInputSize(index: 'int32_t') -> "int32_t":
    """
    ...
    """
    return _mfcc.mfcc_GetInputSize(index)

def mfcc_GetOutputSize(index: 'int32_t') -> "int32_t":
    """
    ...
    """
    return _mfcc.mfcc_GetOutputSize(index)

def mfcc_GetNumNodes() -> "int32_t":
    """mfcc_GetNumNodes() -> int32_t"""
    return _mfcc.mfcc_GetNumNodes()

def mfcc_GetInputShape(index: 'int32_t', shape: 'TensorShape *') -> "void":
    """
    ...
    """
    return _mfcc.mfcc_GetInputShape(index, shape)

def mfcc_GetOutputShape(index: 'int32_t', shape: 'TensorShape *') -> "void":
    """
    ...
    """
    return _mfcc.mfcc_GetOutputShape(index, shape)

def mfcc_GetMetadata(key: 'char *') -> "char *":
    """
    ...
    """
    return _mfcc.mfcc_GetMetadata(key)
class HighResolutionTimer(_object):
    """Proxy of C++ HighResolutionTimer class."""

    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, HighResolutionTimer, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, HighResolutionTimer, name)
    __repr__ = _swig_repr

    def Reset(self) -> "void":
        """
        Reset(HighResolutionTimer self)
        ...
        """
        return _mfcc.HighResolutionTimer_Reset(self)


    def GetMilliseconds(self) -> "double":
        """
        GetMilliseconds(HighResolutionTimer self) -> double
        ...
        """
        return _mfcc.HighResolutionTimer_GetMilliseconds(self)


    def __init__(self):
        """__init__(HighResolutionTimer self) -> HighResolutionTimer"""
        this = _mfcc.new_HighResolutionTimer()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _mfcc.delete_HighResolutionTimer
    __del__ = lambda self: None
HighResolutionTimer_swigregister = _mfcc.HighResolutionTimer_swigregister
HighResolutionTimer_swigregister(HighResolutionTimer)

class MfccWrapper(_object):
    """Proxy of C++ MfccWrapper class."""

    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, MfccWrapper, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, MfccWrapper, name)
    __repr__ = _swig_repr

    def __init__(self):
        """
        __init__(MfccWrapper self) -> MfccWrapper
        ...
        """
        if self.__class__ == MfccWrapper:
            _self = None
        else:
            _self = self
        this = _mfcc.new_MfccWrapper(_self, )
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _mfcc.delete_MfccWrapper
    __del__ = lambda self: None

    def GetInputShape(self, index: 'int'=0) -> "TensorShape":
        """
        GetInputShape(MfccWrapper self, int index=0) -> TensorShape

        Parameters
        ----------
        index: int

        GetInputShape(MfccWrapper self) -> TensorShape
        ...
        """
        return _mfcc.MfccWrapper_GetInputShape(self, index)


    def GetInputSize(self, index: 'int'=0) -> "int":
        """
        GetInputSize(MfccWrapper self, int index=0) -> int

        Parameters
        ----------
        index: int

        GetInputSize(MfccWrapper self) -> int
        ...
        """
        return _mfcc.MfccWrapper_GetInputSize(self, index)


    def GetOutputShape(self, index: 'int'=0) -> "TensorShape":
        """
        GetOutputShape(MfccWrapper self, int index=0) -> TensorShape

        Parameters
        ----------
        index: int

        GetOutputShape(MfccWrapper self) -> TensorShape
        ...
        """
        return _mfcc.MfccWrapper_GetOutputShape(self, index)


    def GetOutputSize(self, index: 'int'=0) -> "int":
        """
        GetOutputSize(MfccWrapper self, int index=0) -> int

        Parameters
        ----------
        index: int

        GetOutputSize(MfccWrapper self) -> int
        ...
        """
        return _mfcc.MfccWrapper_GetOutputSize(self, index)


    def Reset(self) -> "void":
        """
        Reset(MfccWrapper self)
        ...
        """
        return _mfcc.MfccWrapper_Reset(self)


    def IsSteppable(self) -> "bool":
        """
        IsSteppable(MfccWrapper self) -> bool
        ...
        """
        return _mfcc.MfccWrapper_IsSteppable(self)


    def GetMetadata(self, name: 'char const *') -> "char const *":
        """
        GetMetadata(MfccWrapper self, char const * name) -> char const *
        ...
        """
        return _mfcc.MfccWrapper_GetMetadata(self, name)


    def Predict(self, input: 'FloatVector') -> "std::vector< float,std::allocator< float > > &":
        """
        Predict(MfccWrapper self, FloatVector input) -> FloatVector
        ...
        """
        return _mfcc.MfccWrapper_Predict(self, input)

    def __disown__(self):
        self.this.disown()
        _mfcc.disown_MfccWrapper(self)
        return weakref_proxy(self)
MfccWrapper_swigregister = _mfcc.MfccWrapper_swigregister
MfccWrapper_swigregister(MfccWrapper)
