...
class HighResolutionTimer(_object):
    ...
    def __init__(self):
        ...
        this = _model.new_HighResolutionTimer()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
HighResolutionTimer_swigregister = _model.HighResolutionTimer_swigregister
HighResolutionTimer_swigregister(HighResolutionTimer)

class ModelWrapper(_object):
    """Proxy of C++ ModelWrapper class."""
    ...
    def __init__(self):
        ...
        if self.__class__ == ModelWrapper:
            ...
            _self = self
        this = _model.new_ModelWrapper(_self, )
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def GetInputShape(self, index: 'int'=0) -> "TensorShape":
        ...
        GetInputShape(ModelWrapper self) -> TensorShape
    ...
    def GetInputSize(self, index: 'int'=0) -> "int":
        ...
        GetInputSize(ModelWrapper self) -> int
    ...
    def GetOutputShape(self, index: 'int'=0) -> "TensorShape":
        ...
        GetOutputShape(ModelWrapper self) -> TensorShape
    ...
    def GetOutputSize(self, index: 'int'=0) -> "int":
        ...
        GetOutputSize(ModelWrapper self) -> int
    ...
    def IsSteppable(self) -> "bool":
        """
        IsSteppable(ModelWrapper self) -> bool
...
ModelWrapper_swigregister = _model.ModelWrapper_swigregister
